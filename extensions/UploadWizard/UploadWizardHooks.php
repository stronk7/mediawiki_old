	...
	public static $modules = array(
		...
		'ext.uploadWizard' => array(
			...
			'messages' => array(
				...
				'mwe-upwiz-api-error-http',
				'mwe-upwiz-api-error-ok-but-empty',
				'mwe-upwiz-api-error-unknown-code',
				'mwe-upwiz-api-error-uploaddisabled',
				'mwe-upwiz-api-error-nomodule',
				'mwe-upwiz-api-error-mustbeposted',
				'mwe-upwiz-api-error-badaccess-groups',
				...
				'mwe-upwiz-api-error-file-too-large',
				'mwe-upwiz-api-error-filetype-missing',
				'mwe-upwiz-api-error-filetype-banned',
				'mwe-upwiz-api-error-filename-tooshort',
				'mwe-upwiz-api-error-illegal-filename',
				'mwe-upwiz-api-error-verification-error',
				'mwe-upwiz-api-error-hookaborted',
				'mwe-upwiz-api-error-unknown-error',
				'mwe-upwiz-api-error-internal-error',
				'mwe-upwiz-api-error-overwrite',
